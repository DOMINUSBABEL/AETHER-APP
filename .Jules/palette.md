...
## 2026-04-11 - [Hide Visual-Only Lists from Screen Readers]
**Learning:** Found decorative lists, like the zodiac selector in DailyScreen, that provide purely visual context but were exposed to screen readers, causing unnecessary clutter (reading all 12 signs aloud).
**Action:** Always apply `aria-hidden="true"` to containers of ambient, visual-only lists or elements to streamline screen reader output.
