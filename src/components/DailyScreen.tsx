  ...
  return (
    ...
    >
      ...
      <section>
        <div
          role="list"
          aria-label={t('daily.zodiac.label')}
          tabIndex={0}
          className="flex overflow-x-auto space-x-8 pb-4 scroll-smooth no-scrollbar rounded-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background"
        >
