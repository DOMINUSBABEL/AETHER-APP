...
export default function DailyScreen() {
  ...
  return (
    ...
    >
      ...
      <section>
        <div
          className="flex overflow-x-auto space-x-8 pb-4 scroll-smooth no-scrollbar focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-lg"
          tabIndex={0}
          role="list"
          aria-label={t('daily.zodiac') || "Zodiac Signs"}
        >
