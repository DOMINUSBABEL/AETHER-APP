...
export default function DailyScreen() {
  ...
  return (
    ...
    >
      ...
      <section>
        <div
          className="flex overflow-x-auto space-x-8 pb-4 scroll-smooth no-scrollbar focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background"
          tabIndex={0}
          role="list"
