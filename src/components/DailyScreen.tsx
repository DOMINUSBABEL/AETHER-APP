...
export default function DailyScreen() {
  ...
  return (
    ...
    >
      {/* Zodiac Selector */}
      <section>
        <div className="flex overflow-x-auto space-x-8 pb-4 scroll-smooth no-scrollbar focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-lg" tabIndex={0} role="list">
          {zodiacSigns.map((sign, i) => (
            <div key={sign} role="listitem" aria-current={i === activeSignIndex ? 'true' : undefined} className={`flex flex-col items-center space-y-2 shrink-0 ${i === activeSignIndex ? 'text-primary' : 'opacity-30'}`}>
