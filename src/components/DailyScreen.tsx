      ...
      <section className="relative">
        ...
        >
          {zodiacSigns.map((sign, i) => (
            <div key={sign} role="listitem" aria-current={sign === sunSign ? "true" : undefined} className={`flex flex-col items-center space-y-2 shrink-0 ${sign === sunSign ? 'text-primary' : 'opacity-20'}`}>
