  ...
  return (
    ...
    >
      ...
      <section className="relative">
        <div
          role="list"
          aria-label={t('daily.zodiac.list') || 'Zodiac Signs'}
          tabIndex={0}
          className="flex overflow-x-auto space-x-8 pb-4 scroll-smooth no-scrollbar border-b border-outline-variant/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background rounded-lg"
        >
