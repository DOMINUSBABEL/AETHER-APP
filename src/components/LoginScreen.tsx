      ...
      >
        ...
        <div className="w-full space-y-8">
          <div className="text-left space-y-5">
            ...
            <div className="relative group">
              <label htmlFor="login-user-time" className="block font-label text-[10px] tracking-widest uppercase text-outline mb-2 ml-1 transition-colors group-focus-within:text-primary">
