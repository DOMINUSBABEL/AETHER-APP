    ...
    <div className="min-h-screen bg-background text-on-background font-body flex justify-center items-center p-6 relative overflow-hidden">
      ...
      >
        ...
        <div className="w-full space-y-8">
          ...
          <div role="group" aria-label={t('settings.language.label')} className="flex items-center justify-between bg-surface-container-lowest/80 border border-outline-variant/20 rounded-xl p-1.5 backdrop-blur-sm">
            <button
