        ...
        {isSetup ? (
          ...
          >
            ...
            <div className="space-y-6 glass-card p-6 md:p-8 rounded-2xl border border-primary/20">
              ...
              {/* Deck Selection */}
              <div>
                <label id="deck-group" className="block font-label text-[10px] tracking-widest uppercase text-primary mb-3">
                  {t('tarot.setup.deck')}
                </label>
                <div className="grid grid-cols-1 gap-3" role="group" aria-labelledby="deck-group">
                  <button
              ...
              {/* Spread Selection */}
              <div>
                <label id="spread-group" className="block font-label text-[10px] tracking-widest uppercase text-primary mb-3">
                  {t('tarot.setup.spread')}
                </label>
                <div className="grid grid-cols-1 gap-3" role="group" aria-labelledby="spread-group">
