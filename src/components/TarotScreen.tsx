        ...
        {isSetup ? (
          ...
          >
            ...
            <section className="mb-10 text-center flex flex-col items-center">
              <button 
                onClick={backToSetup}
                className="mb-6 inline-flex items-center gap-2 text-on-surface-variant hover:text-primary transition-colors font-label text-[10px] tracking-widest uppercase focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background rounded-md px-2 py-1"
              >
