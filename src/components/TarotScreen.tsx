        ...
        {isSetup ? (
          ...
          >
            ...
            <div className="space-y-6 glass-card p-6 md:p-8 rounded-2xl border border-primary/20">
              ...
              {/* Deck Selection */}
              <div>
                <div id="tarot-deck-label" className="block font-label text-[10px] tracking-widest uppercase text-primary mb-3">
                  {t('tarot.setup.deck')}
                </div>
              ...
              {/* Spread Selection */}
              <div>
                <div id="tarot-spread-label" className="block font-label text-[10px] tracking-widest uppercase text-primary mb-3">
