        ...
        {isSetup ? (
              ...
              <div>
                ...
                <div className="grid grid-cols-1 gap-3">
                  <button
                    ...
                    className={`flex items-center gap-3 p-4 rounded-xl border transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary ${deckType === 'full' ? 'border-primary bg-primary/10 text-primary' : 'border-outline-variant/30 text-on-surface-variant hover:border-primary/50'}`}
                  >
                  ...
                  <button
                    ...
                    className={`flex items-center gap-3 p-4 rounded-xl border transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary ${deckType === 'major' ? 'border-primary bg-primary/10 text-primary' : 'border-outline-variant/30 text-on-surface-variant hover:border-primary/50'}`}
                  >
                ...
                <div className="grid grid-cols-1 gap-3">
                  {(['1', '3', '5'] as const).map((type) => (
                    <button
                      ...
                      className={`flex items-center gap-3 p-4 rounded-xl border transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary ${spreadType === type ? 'border-primary bg-primary/10 text-primary' : 'border-outline-variant/30 text-on-surface-variant hover:border-primary/50'}`}
                    >
          ...
          >
            ...
            <section className="mb-10 text-center flex flex-col items-center">
              <button 
                onClick={backToSetup}
                className="mb-6 inline-flex items-center gap-2 text-on-surface-variant hover:text-primary transition-colors font-label text-[10px] tracking-widest uppercase focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded p-1"
              >
