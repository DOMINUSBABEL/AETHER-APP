        ...
        {isSetup ? (
          ...
          >
            ...
            <div className="space-y-8 glass-card p-8 rounded-2xl border border-primary/20">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 gap-3">
                  <button
                    ...
                    className={`flex items-center gap-3 p-4 rounded-xl border transition-all focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none ${deckType === 'full' ? 'border-primary bg-primary/10 text-primary' : 'border-outline-variant/30 text-on-surface-variant hover:border-primary/50'}`}
                  >
                  ...
                  <button
                    ...
                    className={`flex items-center gap-3 p-4 rounded-xl border transition-all focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none ${deckType === 'major' ? 'border-primary bg-primary/10 text-primary' : 'border-outline-variant/30 text-on-surface-variant hover:border-primary/50'}`}
                  >
                ...
                <div className="grid grid-cols-1 gap-3">
                  {(['1', '3', '5'] as const).map((type) => (
                    <button
                      ...
                      className={`flex items-center gap-3 p-4 rounded-xl border transition-all focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none ${spreadType === type ? 'border-primary bg-primary/10 text-primary' : 'border-outline-variant/30 text-on-surface-variant hover:border-primary/50'}`}
                    >
              ...
              <button
                ...
                className="w-full py-4 rounded-xl bg-primary text-on-primary font-label text-xs tracking-widest uppercase hover:bg-primary/90 transition-colors shadow-lg shadow-primary/20 focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none"
              >
                {t('tarot.setup.start')}
              </button>
            </div>
          ...
          >
            ...
            <section className="mb-10 text-center flex flex-col items-center">
              <button 
                onClick={backToSetup}
                className="mb-6 inline-flex items-center gap-2 text-on-surface-variant hover:text-primary transition-colors font-label text-[10px] tracking-widest uppercase focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none rounded-md"
              >
              ...
              <button 
                ...
                disabled={isDrawing}
                className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-primary/30 text-primary font-label text-[10px] tracking-widest uppercase hover:bg-primary/10 transition-colors disabled:opacity-50 focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none"
              >
