...
const translations = {
  es: {
    'login.title': 'AETHER',
    'login.subtitle': 'BY: DOMINUSBABEL & GARTON',
    ...
    'tarot.pos.cross.1': 'CENTRO',
    'tarot.pos.cross.2': 'DESAFÍO',
    'tarot.pos.cross.3': 'BASE',
    'tarot.pos.cross.4': 'PASADO RECIENTE',
    'tarot.pos.cross.5': 'POSIBLE RESULTADO',
    'tarot.setup.title': 'Configurar Tirada',
    'tarot.setup.deck': 'Mazo a utilizar',
    'tarot.setup.deck.full': 'Mazo Completo (78 cartas)',
    'tarot.setup.deck.major': 'Solo Arcanos Mayores (22 cartas)',
    'tarot.setup.spread': 'Tipo de Tirada',
    'tarot.setup.spread.1': 'Una Carta (Mensaje Rápido)',
    'tarot.setup.spread.3': 'Tres Cartas (Pasado, Presente, Futuro)',
    'tarot.setup.spread.5': 'Cinco Cartas (Cruz Simple)',
    'tarot.setup.start': 'Comenzar Tirada',
    'tarot.setup.back': 'Volver a Configuración',
    ...
    'daily.zodiac.list': 'Lista de los signos del Zodíaco',
    ...
    'settings.time.label': 'Hora de Nacimiento',
    'settings.time.desc': 'Esta hora determina la precisión del cálculo de tu Ascendente.',
    ...
    'tarot.question.label': 'Pregunta al Oráculo',
  ...
  en: {
    ...
    'tarot.pos.cross.1': 'CENTER',
    'tarot.pos.cross.2': 'CHALLENGE',
    'tarot.pos.cross.3': 'FOUNDATION',
    'tarot.pos.cross.4': 'RECENT PAST',
    'tarot.pos.cross.5': 'POSSIBLE OUTCOME',
    'tarot.setup.title': 'Configure Spread',
    'tarot.setup.deck': 'Deck to use',
    'tarot.setup.deck.full': 'Full Deck (78 cards)',
    'tarot.setup.deck.major': 'Major Arcana Only (22 cards)',
    'tarot.setup.spread': 'Spread Type',
    'tarot.setup.spread.1': 'One Card (Quick Message)',
    'tarot.setup.spread.3': 'Three Cards (Past, Present, Future)',
    'tarot.setup.spread.5': 'Five Cards (Simple Cross)',
    'tarot.setup.start': 'Start Reading',
    'tarot.setup.back': 'Back to Configuration',
    ...
    'daily.zodiac.list': 'Zodiac Signs List',
    ...
    'settings.time.label': 'Birth Time',
    'settings.time.desc': 'This time determines the accuracy of your Ascendant calculation.',
    ...
    'tarot.question.label': 'Question to the Oracle',
